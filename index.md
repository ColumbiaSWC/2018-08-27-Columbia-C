...
venue: "Columbia University, R for Reproducible Scientific Analysis"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Butler Library 523, 535 West 114th Street, New York, NY"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Wei Yin", "Co-Instructor: George Garrett"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Thomas Barraro", "Bob Scott", "Sander Antoniades]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
